...
export default function HomeSection({ onPageChange, introCompleted, currentPage }: HomeSectionProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Background dark overlay and vignette for maximum text contrast and legibility */}
        <div className="absolute inset-0 bg-black/40 pointer-events-none z-0" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.8)_0%,rgba(0,0,0,0.3)_60%,transparent_100%)] pointer-events-none z-0" />
